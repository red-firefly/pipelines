...
def dataproc_create_cluster_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-create-cluster:f5b2f24e06ee67c91da8c5dd320685eacbebf25f',
        arguments=[
            '--project', project,
            '--region', region,
            '--name', cluster_name,
...
def dataproc_delete_cluster_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-delete-cluster:f5b2f24e06ee67c91da8c5dd320685eacbebf25f',
        arguments=[
            '--project', project,
            '--region', region,
            '--name', cluster_name,
...
def dataproc_analyze_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-analyze:f5b2f24e06ee67c91da8c5dd320685eacbebf25f',
        arguments=[
            '--project', project,
            '--region', region,
...
def dataproc_transform_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-transform:f5b2f24e06ee67c91da8c5dd320685eacbebf25f',
        arguments=[
            '--project', project,
            '--region', region,
            '--cluster', cluster_name,
...
def dataproc_train_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-train:f5b2f24e06ee67c91da8c5dd320685eacbebf25f',
        arguments=[
            '--project', project,
            '--region', region,
            '--cluster', cluster_name,
...
def dataproc_predict_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-predict:f5b2f24e06ee67c91da8c5dd320685eacbebf25f',
        arguments=[
            '--project', project,
            '--region', region,
            '--cluster', cluster_name,
